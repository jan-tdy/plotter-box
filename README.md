# Parametric Plotter Box Generator
...
- **Multiple Box Styles:** Support for both standard **Rectangular Latching Boxes** and elegant **Pillow Boxes**.
- **Custom Color Coding:** Select your own stroke hex values directly to match your cutter program requirements (e.g., Black for cutting blade, Red for scoring/pen tool).
- **100% Pure Client-Side:** Written completely in vanilla HTML5, CSS3, and JavaScript. No build steps, framework overhead, or server backends required.
